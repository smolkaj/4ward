...
service for direct packet injection, making 4ward a drop-in BMv2
replacement for tools like DVaaS. See [`docs/ENTRY_POINTS.md`](../docs/ENTRY_POINTS.md#p4runtime-server).
