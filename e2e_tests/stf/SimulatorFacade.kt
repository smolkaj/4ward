 ...
 * [fourward.cli.InProcessSimulator] wraps a [fourward.simulator.Simulator] instance directly. Both
 * implement this interface so that [installStfEntries] and the CLI can work with either.
 */
