...
data class StfFile(
  ...
  companion object {
    /**
     * Parses a minimal STF file. Supported directives: packet <port> <hex bytes> — send a packet on
     * ingress port expect <port> <hex bytes> — expect a packet on egress port add <table>
     * <key:value> <action> — install a table entry (TODO)
     *
     * # comment
     */
